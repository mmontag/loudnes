...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=LoudNES Demo Installer\n"
      else:
        line="OutputBaseFilename=LoudNES Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the LoudNES Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the LoudNES installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=LoudNES Demo installer\n"
     else:
       line="SetupWindowTitle=LoudNES installer\n"
