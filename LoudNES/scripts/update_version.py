...
def main():
  ...
  plistpath = scriptpath + "/resources/LoudNES-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LoudNES-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LoudNES-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LoudNES-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LoudNES-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/LoudNES.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/LoudNES.iss",inplace=1):
